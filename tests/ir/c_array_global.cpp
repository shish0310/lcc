...
int main() {
  ...
  arr_g_val->setInitializer(ConstantArray::get(
      arrayType, {ConstantFP::get(irBuilder->getFloatTy(), 1.2f),
  ...
  ArrayType *arrayType1 =
      ArrayType::get(PointerType::getDoublePtrTy(*llvmContext), 2);
  module->getOrInsertGlobal("arr_point_g_val", arrayType1);
  GlobalVariable *arr_point_g_val =
      module->getGlobalVariable("arr_point_g_val");
  arr_point_g_val->setInitializer(
      ConstantArray::get(arrayType1, {double_g_val, double_g_val}));
