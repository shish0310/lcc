...
int main() {
  ...
  auto *func =
      Function::Create(fType, GlobalValue::ExternalLinkage, "max", *module);
  ...
  Value *a_t_val =
      irBuilder->CreateLoad(irBuilder->getInt32Ty(), a_t, "a_t_val");
  Value *b_t_val =
      irBuilder->CreateLoad(irBuilder->getInt32Ty(), b_t, "b_t_val");
#else
