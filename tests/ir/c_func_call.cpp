...
int main() {
  ...
  auto fType = FunctionType::get(irBuilder->getInt32Ty(),
                                 {irBuilder->getInt32Ty()}, false);
  auto func =
      Function::Create(fType, GlobalValue::ExternalLinkage, "fib", *module);
  ...
  Value *condition =
      irBuilder->CreateICmpSLE(func->getArg(0), irBuilder->getInt32(1));
