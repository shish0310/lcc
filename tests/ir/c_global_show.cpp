...
int main() {
  ...
  // int *p = &a;
  GlobalVariable *p = static_cast<GlobalVariable *>(
  ...
  d->setInitializer(ConstantArray::get(
      arrayType, {ConstantFP::get(irBuilder->getDoubleTy(), 1.1),
  ...
  structType->setBody({irBuilder->getInt32Ty(), irBuilder->getFloatTy(),
  ...
  s->setInitializer(ConstantStruct::get(
      structType,
      {irBuilder->getInt32(1), ConstantFP::get(irBuilder->getFloatTy(), 1.1),
       ConstantFP::get(irBuilder->getDoubleTy(), 2.2),
